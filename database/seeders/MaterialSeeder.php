...
class MaterialSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $materialBank = [
            ...
            'hijaiyah' => [
                1 => [
                    ['title' => 'Huruf Alif (ا)', 'subtitle' => 'Alif - Lurus Berdiri Tegak', 'icon_emoji' => '🌙', 'sound_effect' => 'Pelafalan Alif Merdu', 'speech_text' => 'Alif! Huruf hijaiyah pertama yang berdiri lurus tegak.', 'parent_note' => 'Ajak anak berdiri tegak lurus seperti huruf Alif.', 'sort_order' => 1],
                    ...
                    ['title' => 'Huruf Tsa (ث)', 'subtitle' => 'Tsa - Tiga Titik di Atas', 'icon_emoji' => '✨', 'sound_effect' => 'Pelafalan Tsa Lembut', 'speech_text' => 'Tsa! Ucapkan dengan ujung lidah menyentuh gigi depan: Tsa! Memiliki tiga titik di atas.', 'parent_note' => 'Latih anak menempatkan ujung lidah di antara gigi depan.', 'sort_order' => 4],
                    ['title' => 'Huruf Jim (ج)', 'subtitle' => 'Jim - Titik di Tengah Perut', 'icon_emoji' => '🐪', 'sound_effect' => 'Pelafalan Jim Mantap', 'speech_text' => 'Jim! Memiliki perut buncit dengan satu titik di dalamnya. Jim untuk Jamal (Unta).', 'parent_note' => 'Jelaskan titik Jim berada di dalam lengkungan perutnya.', 'sort_order' => 5],
                    ['title' => 'Huruf Ha (ح)', 'subtitle' => 'Ha - Bersih Tanpa Titik', 'icon_emoji' => '🕊️', 'sound_effect' => 'Pelafalan Ha Halus', 'speech_text' => 'Ha! Huruf Ha kecil yang bersih tanpa titik, diucapkan lembut dari tenggorokan.', 'parent_note' => 'Ajak anak melafalkan bunyi Ha dengan hembusan nafas halus.', 'sort_order' => 6],
                    ['title' => 'Huruf Kho (خ)', 'subtitle' => 'Kho - Satu Titik di Atas', 'icon_emoji' => '🥒', 'sound_effect' => 'Pelafalan Kho Mantap', 'speech_text' => 'Kho! Bentuknya melengkung dengan satu titik mahkota di atas kepalanya.', 'parent_note' => 'Tunjukkan bahwa titik huruf Kho berada di atas kepalanya.', 'sort_order' => 7],
                    ['title' => 'Huruf Dal (د)', 'subtitle' => 'Dal - Melengkung Terbuka', 'icon_emoji' => '🐓', 'sound_effect' => 'Pelafalan Dal Jelas', 'speech_text' => 'Dal! Huruf yang melengkung membuka ke arah kiri tanpa titik: Diikun (Ayam Jantan).', 'parent_note' => 'Ajak anak membentuk lengkungan huruf Dal dengan jari.', 'sort_order' => 8],
                    ['title' => 'Huruf Dzal (ذ)', 'subtitle' => 'Dzal - Dal dengan Satu Titik', 'icon_emoji' => '🐺', 'sound_effect' => 'Pelafalan Dzal Ringan', 'speech_text' => 'Dzal! Mirip huruf Dal namun memiliki satu titik mutiara di atasnya: Dzi-bun (Serigala).', 'parent_note' => 'Latih anak mengucapkan Dzal dengan ujung lidah ringan.', 'sort_order' => 9],
                    ['title' => 'Huruf Ro (ر)', 'subtitle' => 'Ro - Meluncur Lembut', 'icon_emoji' => '🛝', 'sound_effect' => 'Pelafalan Ro Bergetar', 'speech_text' => 'Ro! Melengkung meluncur ke bawah seperti papan seluncuran.', 'parent_note' => 'Ajak anak menggerakkan tangan seperti meluncur di seluncuran.', 'sort_order' => 10],
                ],
                2 => [
                    ['title' => 'Huruf Zai (ز)', 'subtitle' => 'Zai - Ro dengan Satu Titik', 'icon_emoji' => '🌸', 'sound_effect' => 'Pelafalan Zai Berdesing', 'speech_text' => 'Zai! Bentuknya persis seperti huruf Ro dengan satu titik di atasnya: Zahrotun (Bunga).', 'parent_note' => 'Tunjukkan letak satu titik di atas huruf Zai.', 'sort_order' => 1],
                    ['title' => 'Huruf Sin (س)', 'subtitle' => 'Sin - Tiga Gigi Rapi', 'icon_emoji' => '🐟', 'sound_effect' => 'Pelafalan Sin Berdesis', 'speech_text' => 'Sin! Memiliki tiga lengkungan gigi kecil tanpa titik: Samakun (Ikan).', 'parent_note' => 'Ajak anak menghitung 3 lengkungan gigi pada huruf Sin.', 'sort_order' => 2],
                    ['title' => 'Huruf Syin (ش)', 'subtitle' => 'Syin - Tiga Titik di Atas Gigi', 'icon_emoji' => '☀️', 'sound_effect' => 'Pelafalan Syin Berhembus', 'speech_text' => 'Syin! Seperti huruf Sin namun memiliki tiga titik bintang di atasnya: Syamsun (Matahari).', 'parent_note' => 'Latih hembusan bunyi Syin bersama anak.', 'sort_order' => 3],
                    ['title' => 'Huruf Shod (ص)', 'subtitle' => 'Shod - Lengkungan Tebal', 'icon_emoji' => '🦅', 'sound_effect' => 'Pelafalan Shod Tebal', 'speech_text' => 'Shod! Huruf tebal dengan kepala melingkar dan lengkungan mangkok: Soqrun (Elang).', 'parent_note' => 'Ajak anak melafalkan Shod dengan bibir sedikit membulat tebal.', 'sort_order' => 4],
                    ['title' => 'Huruf Dhod (ض)', 'subtitle' => 'Dhod - Shod dengan Satu Titik', 'icon_emoji' => '🐸', 'sound_effect' => 'Pelafalan Dhod Khas', 'speech_text' => 'Dhod! Huruf istimewa bahasa Arab yang memiliki satu titik di atasnya: Dhifdaun (Katak).', 'parent_note' => 'Jelaskan bahasa Arab dikenal sebagai bahasa Dhod.', 'sort_order' => 5],
                    ['title' => 'Huruf Tho (ط)', 'subtitle' => 'Tho - Tiang Tegak dan Bulat', 'icon_emoji' => '✈️', 'sound_effect' => 'Pelafalan Tho Kuat', 'speech_text' => 'Tho! Memiliki tiang tegak lurus yang menancap di atas lengkungan: Thoo-irotun (Pesawat).', 'parent_note' => 'Tunjukkan bentuk tiang tegak pada huruf Tho.', 'sort_order' => 6],
                    ['title' => 'Huruf Zho (ظ)', 'subtitle' => 'Zho - Tho dengan Satu Titik', 'icon_emoji' => '🦌', 'sound_effect' => 'Pelafalan Zho Tebal', 'speech_text' => 'Zho! Bentuknya mirip huruf Tho dengan satu titik di atasnya: Zhab-yun (Rusa).', 'parent_note' => 'Latih pelafalan Zho tebal dengan ujung lidah.', 'sort_order' => 7],
                    ['title' => "Huruf 'Ain (ع)", 'subtitle' => "'Ain - Lengkungan Kepala & Perut", 'icon_emoji' => '🍇', 'sound_effect' => "Pelafalan 'Ain Dalam", 'speech_text' => "Ain! Memiliki kepala kecil di atas dan perut besar melengkung di bawah: 'Inabun (Anggur).", 'parent_note' => "Latih pelafalan bunyi 'Ain dari tengah tenggorokan.", 'sort_order' => 8],
                    ['title' => 'Huruf Ghoin (غ)', 'subtitle' => "Ghoin - 'Ain dengan Satu Titik", 'icon_emoji' => '☁️', 'sound_effect' => 'Pelafalan Ghoin Basah', 'speech_text' => "Ghoin! Seperti huruf 'Ain yang diberi satu titik di atas kepalanya: Ghoimun (Awan).", 'parent_note' => 'Tunjukkan titik di atas kepala huruf Ghoin.', 'sort_order' => 9],
                    ['title' => 'Huruf Fa (ف)', 'subtitle' => 'Fa - Satu Titik di Atas Lingkaran', 'icon_emoji' => '🐘', 'sound_effect' => 'Pelafalan Fa Ringan', 'speech_text' => 'Fa! Memiliki lingkaran kepala di atas dan satu titik: Fiilun (Gajah).', 'parent_note' => 'Ajak anak menyentuhkan gigi atas ke bibir bawah saat melafalkan Fa.', 'sort_order' => 10],
                ],
                3 => [
                    ['title' => 'Huruf Qof (ق)', 'subtitle' => 'Qof - Dua Titik di Atas Mangkok', 'icon_emoji' => '🏹', 'sound_effect' => 'Pelafalan Qof Mantap', 'speech_text' => 'Qof! Memiliki mangkok melengkung ke dalam dengan dua titik ceria di atasnya: Qousun (Busur Panah).', 'parent_note' => 'Latih pelafalan bunyi Qof mantap dari pangkal lidah.', 'sort_order' => 1],
                    ['title' => 'Huruf Kaf (ك)', 'subtitle' => 'Kaf - Ada Hamzah Kecil di Dalam', 'icon_emoji' => '📖', 'sound_effect' => 'Pelafalan Kaf Renyah', 'speech_text' => 'Kaf! Berbentuk wadah lebar dengan tanda hamzah kecil di dalamnya: Kitabun (Buku).', 'parent_note' => 'Tunjukkan tanda hamzah kecil di dalam huruf Kaf.', 'sort_order' => 2],
                    ['title' => 'Huruf Lam (ل)', 'subtitle' => 'Lam - Tongkat Melengkung Indah', 'icon_emoji' => '🍋', 'sound_effect' => 'Pelafalan Lam Jelas', 'speech_text' => 'Lam! Berdiri tegak dan melengkung ke bawah seperti tongkat: Laymuun (Lemon).', 'parent_note' => 'Ajak anak menggambar bentuk tongkat huruf Lam di udara.', 'sort_order' => 3],
                    ['title' => 'Huruf Mim (م)', 'subtitle' => 'Mim - Lingkaran Ekor Turun', 'icon_emoji' => '💧', 'sound_effect' => 'Pelafalan Mim Dengung', 'speech_text' => 'Mim! Memiliki kepala bulat kecil dengan ekor yang turun ke bawah: Maa-un (Air).', 'parent_note' => 'Ajak anak merapatkan bibir saat melafalkan huruf Mim.', 'sort_order' => 4],
                    ['title' => 'Huruf Nun (ن)', 'subtitle' => 'Nun - Mangkok Satu Titik di Atas', 'icon_emoji' => '🌟', 'sound_effect' => 'Pelafalan Nun Dengung', 'speech_text' => 'Nun! Memiliki mangkok bulat dengan satu titik mutiara di tengahnya: Najmun (Bintang).', 'parent_note' => 'Tunjukkan letak titik huruf Nun di dalam mangkoknya.', 'sort_order' => 5],
                    ['title' => 'Huruf Wawu (و)', 'subtitle' => 'Wawu - Kepala Melingkar Indah', 'icon_emoji' => '🌹', 'sound_effect' => 'Pelafalan Wawu Bulat', 'speech_text' => 'Wawu! Memiliki kepala melingkar dengan ekor meluncur: Wardatun (Bunga Mawar).', 'parent_note' => 'Ajak anak membulatkan bibir saat melafalkan Wawu.', 'sort_order' => 6],
                    ['title' => 'Huruf Ha Besar (هـ)', 'subtitle' => 'Ha Besar - Bulat Melingkar Lembut', 'icon_emoji' => '🎁', 'sound_effect' => 'Pelafalan Ha Besar', 'speech_text' => 'Ha Besar! Huruf Ha berongga bulat yang dibaca halus dan lega: Hadiyyatun (Hadiah).', 'parent_note' => 'Jelaskan perbedaan bunyi Ha besar dan Ha kecil.', 'sort_order' => 7],
                    ['title' => 'Huruf Lam Alif (لا)', 'subtitle' => 'Lam Alif - Bersahabat Bergandengan', 'icon_emoji' => '🕌', 'sound_effect' => 'Pelafalan Lam Alif', 'speech_text' => 'Lam Alif! Dua huruf istimewa yang saling bersahabat dan bergandengan erat.', 'parent_note' => 'Gambarkan bentuk silang indah huruf Lam Alif di kertas.', 'sort_order' => 8],
                    ['title' => 'Huruf Hamzah (ء)', 'subtitle' => 'Hamzah - Kepala Mungil Pemutus Suara', 'icon_emoji' => '💎', 'sound_effect' => 'Pelafalan Hamzah Tegas', 'speech_text' => "Hamzah! Bentuknya mungil seperti kepala huruf 'Ain untuk memantapkan suara.", 'parent_note' => 'Jelaskan bahwa Hamzah berbunyi hentakan nafas yang jelas.', 'sort_order' => 9],
                    ['title' => 'Huruf Ya (ي)', 'subtitle' => 'Ya - Huruf Terakhir Dua Titik Bawah', 'icon_emoji' => '🦆', 'sound_effect' => 'Pelafalan Ya Ceria', 'speech_text' => 'Ya! Huruf hijaiyah penutup seperti badan bebek dengan dua titik di bawahnya: Yadun (Tangan).', 'parent_note' => 'Apresiasi anak karena telah berhasil menguasai seluruh huruf hijaiyah dari Alif sampai Ya!', 'sort_order' => 10],
                ],
            ],
